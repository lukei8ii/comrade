 ...
 * 
 * Usage examples:
 	1. Messenger.AddListener<GameObject>(Events.PropCollected, PropCollected);
 	   Messenger.Broadcast<GameObject>(Events.PropCollected, prop);
 	2. Messenger.AddListener<float>(Events.SpeedChanged, SpeedChanged);
 	   Messenger.Broadcast<float>(Events.SpeedChanged, 0.5f);
 * 
